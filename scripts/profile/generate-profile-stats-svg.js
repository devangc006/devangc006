...
<svg xmlns="http://www.w3.org/2000/svg" width="800" height="470" viewBox="0 0 800 470" role="img" aria-labelledby="title desc">
  ...
  <style>
    ...
    .line { opacity:0; animation: reveal 12s ease-in-out infinite; } .cursor { animation: blink 1s steps(1,end) infinite; }
    @keyframes reveal { 0%,4% { opacity:0 } 10%,88% { opacity:1 } 94%,100% { opacity:0 } }
